...
curl_setopt($ch, CURLOPT_URL, 'http://www.botti.guion78.com/repo/getVersion.php');
...
if ($currentVersion > $localVersion) {
	...
	$outVersion .= '
	<div>
            <strong>Una nuova versione di [Bot]Ti presente: ' . $currentVersion . '</strong><br />
	...
	// imposto l'URL da interrogare
	curl_setopt($ch, CURLOPT_URL, 'http://www.botti.guion78.com/repo/note.htm');
	...
	// Comunico che va tutto bene così
        $localVersion = str_replace('_', '.', $localVersion);
	$outVersion .= '<p><strong>Questa versione di [Bot]Ti &egrave; aggiornata. Non serve fare nulla.</strong> Stai usando la versione: '.$localVersion.'<br />' . PHP_EOL;
}
?>