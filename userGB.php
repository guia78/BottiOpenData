...
<?php
$recordTot = 100; //Max Record
$name = dbDemName(); //Name of Bot
$forPage = 20; //Limit record view from page
$totPage=ceil($recordTot/$forPage); //Ceil for page
?>
	...
	<div class="container">				
		<div class="row d-flex align-items-center justify-content-center">
			<div class="about-content">
				<h1 class="text-white">
					Ex utenti molto attivi.				
				</h1>	
				<p class="text-white link-nav"><a href="admin.php">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="userGB.php"> Ex Utenti attivi</a></p>
			</div>	
		</div>
	</div>
</section>
...
<section class="products-area section-gap">
	<div class="container">   
		...
		if($recordTot>0){ 
			...
			$userActivePage = dbTrackerUserGoodBye($init, $forPage); ?>
					...
					<tbody>
						...
						foreach ($userActivePage as $user) {
							...
							<tr>
								...
								<td><?php if(!empty($delete)){echo $delete;}else{echo "--";} ?></td>
								<td><?php if(!empty($user['DateDiff'])){echo $user['DateDiff'];}else{echo "--";} ?></td>
							</tr>
						<?php } ?>
					</tbody>
				</table>				
